...
tool_category_interest_rates_routes = Blueprint(
    "tool_category_interest_rates_routes", __name__
)
...
INTEREST_RATES_TOOL_CATEGORIES = {
    ...
    "basic-interest-rates-analysis": {
        ...
        "tools": [
            {
                "title": "Continuous Compounding to m-Compounding Rate",
                "description": "Convert m-compounding rates to continuous compounding rates.",
                "url": "/tools/basic-interest-rates-analysis/continuous-compounding-rate",
            },
            {
                "title": "m-Compounding to Continuous Rate",
                "description": "Convert m-compounding rates to continuous compounding rates.",
                "url": "/tools/basic-interest-rates-analysis/m-to-continuous-compounding-rate",
            },
            {
                "title": "Bond Pricing",
                "description": "Calculate the price of bonds based on market rates.",
                "url": "/tools/basic-interest-rates-analysis/bond-pricing",
            },
            {
                "title": "Duration and Convexity",
                "description": "Compute Macaulay, Modified Duration for bonds & Convexity.",
    ...
    "forward-rate-agreements": {
        ...
        "tools": [
            {
                "title": "Payoff of FRA",
                "description": "Calculate the payoff of a forward rate agreement.",
                "url": "/tools/forward-rate-agreements/payoff-of-fra",
            },
            {
                "title": "Valuation of FRA",
                "description": "Evaluate the value of forward rate agreements.",
