...
STATISTICS_TOOL_CATEGORIES = {
    ...
    "descriptive-analysis": {
        ...
        "tools": [
            {
                "title": "Mean",
                "description": "Calculate the average value of a dataset.",
                "url": "/tools/descriptive-analysis/mean",
            },
            {
                "title": "Median",
                "description": "Determine the middle value in an ordered dataset.",
                "url": "/tools/descriptive-analysis/median",
            },
            {
                "title": "Mode",
                "description": "Identify the most frequent value(s) in a dataset.",
            ...
            },
            {
                ...
                "description": "Compute the spread of the middle 50% of the data.",
                "url": "/tools/descriptive-analysis/iqr",
            },
            {
                "title": "Skewness",
                "description": "Measure the asymmetry of the probability distribution of a dataset.",
                "url": "/tools/descriptive-analysis/skewness",
            },
            {
                "title": "Kurtosis",
                "description": "Evaluate the 'tailedness' of the data distribution.",
    ...
    "inferential-statistics": {
        ...
        "tools": [
            ...
            {
                "title": "z-test",
                "description": "Conduct a z-test for hypothesis testing of large sample sizes.",
                "url": "/tools/inferential-statistics/z-test",
            },
            {
                "title": "Chi-Square Test",
                "description": "Evaluate the independence of categorical variables.",
                "url": "/tools/inferential-statistics/chi-square",
            },
            {
                "title": "Confidence Intervals",
                "description": "Calculate intervals to estimate population parameters.",
            ...
            },
            {
                ...
                "url": "/tools/inferential-statistics/p-value",
            },
            {
    ...
    "probability-tools": {
        ...
        "tools": [
            {
                "title": "Probability Density Function (Normal PDF)",
                "description": "Calculate the PDF for continuous random variables.",
                "url": "/tools/probability-tools/pdf",
            },
            {
                "title": "Cumulative Distribution Function (Normal CDF)",
            ...
            {
                "title": "T-Distribution (Student CDF)",
