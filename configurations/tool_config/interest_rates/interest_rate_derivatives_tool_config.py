...
INTEREST_RATE_DERIVATIVES_TOOL_CONFIG = {
    ...
    "payoff-of-fra": {
        ...
        "graphs": [{"name": "Payoff Evolution"}, {"name": "Fixed Leg vs Floating Leg"}],
    },
    # Valuation of FRA
    "valuation-of-fra": {
        ...
        "graphs": [{"name": "FRA Payoff"}, {"name": "FRA fixed vs floating"}],
    },
    ...
    "interest-rate-swap-valuation": {
        ...
        "inputs": [
            ...
            {
                "label": "Discount Factors (comma-separated)",
                "id": "discount_factors",
                "type": "array",
                "placeholder": "[0.95, 0.94, 0.93]",
                "optional": False,
            },
            {
                "label": "Floating Cash Flows (comma-separated)",
                "id": "floating_cash_flows",
                "type": "array",
                "placeholder": "[30000, 30000, 30000]",
                "optional": False,
            },
        ],
    ...
    "basis-swap-analysis": {
        ...
        "inputs": [
            ...
            {
                "label": "Benchmark 1 Rate",
                "id": "benchmark__rate_1",
                "type": "number",
                "placeholder": "0.02",
                "optional": False,
            },
            {
                "label": "Benchmark 2 Rate",
                "id": "benchmark_rate_2",
                "type": "number",
                "placeholder": "0.025",
                "optional": False,
