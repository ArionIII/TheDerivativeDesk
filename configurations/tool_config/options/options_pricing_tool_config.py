...
OPTION_PRICING_TOOL_CONFIG = {
    ...
    "black-scholes-option": {
        ...
        "inputs": [
            ...
            {
                "label": "Position Type (greeks plotting)",
                "id": "position_type",
                "type": "select",
                "options": ["LONG", "SHORT"],
            },
        ...
        "outputs": ["Option Price"],
        "visualization": True,
        "graphs": [{"name": "Payoff Curve"}, {"name": "Greeks Sensitivity"}],
        "keywords": [
            "black scholes",
            "call option",
            "put option",
...
""",
    ...
    "monte-carlo-option": {
        ...
        "inputs": [
            ...
            {
                "label": "Number of Simulations/Paths",
                "id": "num_simulations",
                "type": "number",
                "placeholder": "4000",
            },
            {
                "label": "Number of Steps (intra-path)",
                "id": "num_steps",
                "type": "number",
                "placeholder": "365",
            },
