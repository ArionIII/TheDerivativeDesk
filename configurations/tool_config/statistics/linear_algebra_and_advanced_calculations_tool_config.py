LINEAR_ALGEBRA_AND_ADVANCED_CALCULATION_TOOL_CONFIG = {
    "singular-value-decomposition": {
        ...
        "inputs": [
            {"label": "Matrix", "id": "matrix", "type": "array", "placeholder": "[[1, 2], [3, 4]]", "optional": False},
        ],
    ...
    "principal-component-analysis": {
        ...
        "inputs": [
            {"label": "Data Matrix", "id": "data_matrix", "type": "array", "placeholder": "[[1, 2], [3, 4], [5, 6]]", "optional": False},
        ],
    ...
    "matrix-multiplication": {
        ...
        "inputs": [
            {"label": "Matrix A", "id": "matrix_a", "type": "array", "placeholder": "[[1, 2], [3, 4]]", "optional": False},
            {"label": "Matrix B", "id": "matrix_b", "type": "array", "placeholder": "[[5, 6], [7, 8]]", "optional": False},
        ],
