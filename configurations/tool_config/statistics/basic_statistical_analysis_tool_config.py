...
BASIC_STATISTICAL_ANALYSIS_TOOL_CONFIG = {
    "mean": {
        ...
        "inputs": [
            {"label": "Dataset", "id": "dataset", "type": "array", "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'comprehensive_basic_analysis.csv'))}", "optional": False},
        ...
        "inputs": [
{
    ...
    "id": "dataset",
    "type": "array",
    "placeholder": generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'comprehensive_basic_analysis.csv'))
},
    {"label": "CSV File", "id": "csv_file", "type": "file", "accept": ".csv", "data_target": "dataset", "template": "/static/templates/comprehensive_basic_analysis.csv", "optional": True},
        ],
    ...
    "inputs": [
{
    ...
    "t-test": {
        ...
        "inputs": [
            {"label": "Sample Dataset A", "id": "sample_a", "type": "array", "placeholder": "[1,2,3]"},
            {"label": "Sample Dataset B (optional)", "id": "sample_b", "type": "array", "placeholder": "[4,5,6]", "optional": True},
    ...
    "z-test": {
        ...
        "inputs": [
            {"label": "Sample Mean", "id": "sample_mean", "type": "number", "placeholder": "5.5"},
            {"label": "Population Mean", "id": "population_mean", "type": "number", "placeholder": "5.0"},
            {"label": "Standard Deviation", "id": "std_dev", "type": "number", "placeholder": "1.5"},
            {"label": "Sample Size", "id": "sample_size", "type": "number", "placeholder": "30"},
        ],
    ...
    "chi-square": {
        ...
        "inputs": [
            {"label": "Observed Frequencies", "id": "observed", "type": "array", "placeholder": "[10,20,30]"},
            {"label": "Expected Frequencies", "id": "expected", "type": "array", "placeholder": "[15,15,30]"}
        ],
    ...
    "confidence-intervals": {
        ...
        "inputs": [
            ...
            {"label": "Standard Deviation", "id": "std_dev", "type": "number", "placeholder": "1.5"},
            {"label": "Sample Size", "id": "sample_size", "type": "number", "placeholder": "30"},
            {"label": "Confidence Level", "id": "confidence_level", "type": "number", "placeholder": "0.95"}
        ],
    ...
    "p-value": {
        ...
        "inputs": [
            {"label": "Test Statistic", "id": "test_statistic", "type": "number", "placeholder": "2.5"},
            {"label": "Degrees of Freedom (optional)", "id": "degrees_of_freedom", "type": "number", "placeholder": "10", "optional": True},
    ...
    "anova": {
        ...
        "inputs": [
            {"label": "Group A Data", "id": "group_a", "type": "array", "placeholder": "[1,2,3]"},
            {"label": "Group B Data", "id": "group_b", "type": "array", "placeholder": "[4,5,6]"},
            {"label": "Group C Data (optional)", "id": "group_c", "type": "array", "placeholder": "[7,8,9]", "optional": True},
        ],
    ...
    "simple-regression": {
        ...
        "inputs": [
            {"label": "Independent Variable (X)", "id": "independent_variable", "type": "array", "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'simple_regression_1.csv'))}", },
            {"label": "Dependent Variable (Y)", "id": "dependent_variable", "type": "array", "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'simple_regression_2.csv'))}"},
    ...
    "multiple-regression": {
        ...
        "inputs": [
            {"label": "Independent Variables (\( X_k \))", "id": "independent_variables", "type": "array", "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'multi_regression_1.csv'))}"

},
            {"label": "Dependent Variable (Y)", "id": "dependent_variables", "type": "array", "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'multi_regression_2.csv'))}"
            ...
            {"label": "CSV File - Y", "id": "csv_file_2", "type": "file", "accept": ".csv", "data_target": "dependent_variables", "template": "/static/templates/multi_regression_2.csv", "optional": True},
        ],
    ...
    "pdf": {
        ...
        "inputs": [
            {"label": "Value (x)", "id": "value", "type": "number", "placeholder": "1.5"},
            {"label": "Mean (μ)", "id": "mean", "type": "number", "placeholder": "0"},
            {"label": "Standard Deviation (σ)", "id": "std_dev", "type": "number", "placeholder": "1"}
        ],
        "outputs": ["PDF Value"]
    },
    "cdf": {
    ...
    "binomial-distribution": {
        ...
        "inputs": [
            {"label": "Number of Trials (n)", "id": "num_trials", "type": "number", "placeholder": "10"},
            {"label": "Probability of Success (p)", "id": "prob_success", "type": "number", "placeholder": "0.5"},
            {"label": "Number of Successes (k)", "id": "num_successes", "type": "number", "placeholder": "5"}
        ],
        "outputs": ["Probability"]
    },
    "poisson-distribution": {
        ...
        "inputs": [
            {"label": "Number of Events (k)", "id": "num_events", "type": "number", "placeholder": "3"},
            {"label": "Average Rate (λ)", "id": "rate", "type": "number", "placeholder": "5"}
        ],
        "outputs": ["Probability"]
    },
    "normal-distribution": {
    ...
    "t-distribution": {
        ...
        "inputs": [
            {"label": "Value (t)", "id": "value", "type": "number", "placeholder": "2.5"},
            {"label": "Degrees of Freedom (df)", "id": "degrees_freedom", "type": "number", "placeholder": "10"}
        ],
        "outputs": ["Probability"]
    }
}
