        ...
        "inputs": [
            {
                ...
                "id": "dataset",
                "type": "array",
                "placeholder": f"{generate_input_from_file(os.path.join(os.getcwd(), 'static', 'templates', 'sample_time_series.csv'))}",
                "optional": False,
            },
            {
                "label": "CSV File",
