HEDGING_TOOL_CONFIG = {
    ...
    "minimum_variance_hedge_ratio": {
        ...
        "inputs": [
            {
                "label": "Standard Deviation of Spot Changes (σₛ)",
                "id": "std_change_spot",
                "type": "number",
                "placeholder": "0.05",
                "step": "any",
            ...
            {
                "label": "Standard Deviation of Futures Changes (σₓ)",
                "id": "std_change_futures",
                "type": "number",
                "placeholder": "0.04",
                "step": "any",
            },
