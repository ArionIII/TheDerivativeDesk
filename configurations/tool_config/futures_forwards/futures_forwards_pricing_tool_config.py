...
FUTURES_FORWARDS_TOOL_CONFIG = {
 "forward_pricing_no_income": {
        ...
        "visualization": False,
        "keywords": [
            "forward pricing", "no income", "investment asset", "risk-free rate",
            "forward contracts", "financial derivatives", "time to maturity",
            "pricing model", "cost of carry", "simple forward"
        ]
    },
    "forward_pricing_with_income": {
        ...
        "visualization": False,
        "keywords": [
            "forward pricing", "income asset", "investment income", "financial asset",
            "asset valuation", "pricing formula", "derivatives pricing",
            "time to maturity", "forward contract income", "pricing income assets"
        ]
    },
    "forward_pricing_with_yield": {
        ...
        "visualization": False,
        "keywords": [
            "forward pricing", "yield rate", "asset yield", "investment yield",
            "pricing model", "financial derivatives", "forward contracts",
            "risk-free rate", "yield calculation", "time to maturity"
        ]
    },
    "forward_pricing_foreign_currency": {
        ...
        "visualization": False,
        "keywords": [
            "forward pricing", "foreign currency", "interest rate parity", "forex pricing",
            "currency hedging", "spot price", "domestic risk-free rate", "foreign risk-free rate",
            "forward contracts", "fx forward"
        ]
    },
    "futures_pricing_stock_index": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "stock index", "dividend yield", "index pricing",
            "risk-free rate", "financial derivatives", "pricing models",
            "investment valuation", "time to maturity", "index futures"
        ]
    },
    "futures_pricing_with_storage": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "commodity futures", "storage costs", "risk-free rate",
            "financial derivatives", "commodity valuation", "pricing models",
            "time to maturity", "cost of carry", "commodity contracts"
        ]
    },
    "futures_pricing_proportional_costs_yield": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "proportional storage costs", "convenience yield",
            "commodity futures", "risk-free rate", "financial derivatives",
            "pricing models", "commodity valuation", "time to maturity",
    ...
    "futures_pricing_nonproportional_costs_yield": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "non-proportional storage costs", "convenience yield",
            "commodity pricing", "financial derivatives", "pricing models",
            "storage costs", "risk-free rate", "time to maturity", "commodity contracts"
        ]
    },
    "futures_pricing_cost_of_carry": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "investment asset", "cost of carry", "pricing model",
            "risk-free rate", "financial derivatives", "asset valuation",
            "time to maturity", "pricing futures", "investment contracts"
        ]
    },
    "futures_pricing_cost_of_carry_yield": {
        ...
        "visualization": False,
        "keywords": [
            "futures pricing", "consumption asset", "cost of carry", "convenience yield",
            "commodity futures", "financial derivatives", "pricing models",
            "asset valuation", "time to maturity", "pricing consumption assets"
        ]
    }
}
