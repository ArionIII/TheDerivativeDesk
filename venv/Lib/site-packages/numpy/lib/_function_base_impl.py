...
def _parse_gufunc_signature(signature):
    ...
    ---------
    signature : string
        Generalized universal function signature, ``(m,n),(n,p)->(m,p)``
        for ``np.matmul``.
...
class vectorize:
    ...
    signature : string, optional
        Generalized universal function signature, ``(m,n),(n)->(m)`` for
...
def percentile(a,
    ...
    # Use dtype of array if possible (if q is a python int or float)
