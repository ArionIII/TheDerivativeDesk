...
def _binary_method(ufunc, name):
    """Implement a forward binary method with a ufunc, __add__."""
    def func(self, other):
...
def _reflected_binary_method(ufunc, name):
    """Implement a reflected binary method with a ufunc, __radd__."""
    def func(self, other):
        if _disables_array_ufunc(other):
            return NotImplemented
...
def _inplace_binary_method(ufunc, name):
    """Implement an in-place binary method with a ufunc, __iadd__."""
    def func(self, other):
