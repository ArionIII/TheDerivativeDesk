...
them. All of the ufuncs that make use of Python operators (+, -, etc.)
have equivalent functions defined (e.g. add() for +)

Type coercion
=============

What happens when a binary operator (+,-,\\*,/, etc) deals with arrays of
...
if the Python scalar is of a higher 'kind' than the array (float
