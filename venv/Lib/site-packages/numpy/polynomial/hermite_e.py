...
def hermediv(c1, c2):
    ...
    order "term" to highest, [1,2,3] represents the series
    ``P_0 + 2*P_1 + 3*P_2``.
...
def hermeder(c, m=1, scl=1, axis=0):
    ...
    axis, [1,2,3] represents the series ``1*He_0 + 2*He_1 + 3*He_2``
...
def hermeint(c, m=1, k=[], lbnd=0, scl=1, axis=0):
    ...
    **multiplied** by `scl` and an integration constant, `k`, is added.
    ...
    coefficients from low to high degree along each axis, [1,2,3]
