...
simulation_and_bayesian_analysis_routes = Blueprint("simulation_and_bayesian_analysis_routes", __name__)
...
@simulation_and_bayesian_analysis_routes.route("/tools/monte-carlo-simulations/<tool_key>", methods=["GET", "POST"])
def handle_monte_carlo_simulation_tool(tool_key):
    return handle_simulation_and_bayesian_analysis_tool_request(tool_key, "simulation_and_bayesian_analysis")

@simulation_and_bayesian_analysis_routes.route("/tools/bayesian-analysis/<tool_key>", methods=["GET", "POST"])
