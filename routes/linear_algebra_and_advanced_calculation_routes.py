...
# Blueprints
linear_algebra_and_advanced_calculations_routes = Blueprint("linear_algebra_and_advanced_calculations_routes", __name__)
...
# Routes
@linear_algebra_and_advanced_calculations_routes.route("/tools/linear-algebra-tools/<tool_key>", methods=["GET", "POST"])
def handle_linear_algebra_tool(tool_key):
    return handle_tool_request(tool_key, "linera_algebra")

@linear_algebra_and_advanced_calculations_routes.route("/tools/advanced-calculations/<tool_key>", methods=["GET", "POST"])
