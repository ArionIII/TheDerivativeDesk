...
interest_rate_fundamentals_routes = Blueprint(
    "interest_rate_fundamentals_routes", __name__
)
...
# Routes
@interest_rate_fundamentals_routes.route(
    "/tools/basic-interest-rates-analysis/<tool_key>", methods=["GET", "POST"]
)
...
@interest_rate_fundamentals_routes.route(
    "/tools/term-structure-construction/<tool_key>", methods=["GET", "POST"]
)
